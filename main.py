...
splash = tk.Frame(root, bg="#003459")
splash.propagate(False)
splash.configure(width=1600,height=900, background="#003459")

sb = tk.PhotoImage(file="./Images/logo.png").subsample(2)
logo = tk.Label(splash, image=sb, bg="#003459")
logo.image = sb
logo.pack(pady=(50,60))

sbn = tk.PhotoImage(file='./Images/logoname.png').subsample(2)
logoname = tk.Label(splash, image=sbn, bg="#003459")
logoname.image = sbn
logoname.pack()

sbt1 = tk.PhotoImage(file='./Images/tg1.png').subsample(2)
tagline1 = tk.Label(splash, image=sbt1, bg="#003459")
tagline1.pack(padx=(30,0), pady=(80,40))

lbl = ImageLabel(splash)
lbl.configure(bg="#003459")
lbl.pack()
lbl.load('./Images/loading.gif')

sbt2 = tk.PhotoImage(file='./Images/tg2.png').subsample(2)
tagline2 = tk.Label(splash, image=sbt2, bg="#003459")
tagline2.pack(padx=(30,0), pady=10)
